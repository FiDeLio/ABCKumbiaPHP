...
jQuery(jQuery.jGlideMenu.currentElement).find('div.jGM_header a').bind('click',function(){
	...
	jQuery.jGlideMenu.toggleDisplay(true);return false;
	});
...
jQuery.jGlideMenu.loadTile(jQuery.jGlideMenu.initialTile,jQuery.jGlideMenu.URLParams);});},toggleDisplay:function(r)
...
+jQuery.jGlideMenu.imagePath+'arrow_up.gif" style="margin-left:-15px;" alt="Scroll Up"/></a></div>';template+='<div class="jGM_content">';for(var i=0;i<l.length;i++)
...
+jQuery.jGlideMenu.imagePath+'arrow_dn.gif" style="margin: 10px 0 0 -15px;" alt="Scroll Up"/></a></div>';return template;},errorTrap:function(m)
